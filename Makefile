...
HEADERS=csum.h hash-tree.h results-tree.h kernel.h list.h rbtree.h dedupe.h \
	...
	sha256.h sha256-config.h bswap.h bloom.h d_tree.h btrfs-internal.h
CFILES=duperemove.c hash-tree.c results-tree.c rbtree.c dedupe.c filerec.c \
	...
	run_dedupe.c csum.c bloom.c d_tree.c btrfs-internal.c
...
hashstats_obj = $(hash_obj) rbtree.o hash-tree.o filerec.o util.o serialize.o \
	 results-tree.o csum.o d_tree.o bloom.o btrfs-util.o btrfs-internal.o
...
btrfs_test_obj = rbtree.o util.o btrfs-internal.o filerec.o hash-tree.o	\
	$(hash_obj) csum.o serialize.o d_tree.o bloom.o
...
btrfs-test: $(btrfs_test_obj) btrfs-util.c
	$(CC) $(CFLAGS) -DBTRFS_UTIL_TEST btrfs-util.c $(btrfs_test_obj) -o btrfs-test $(LIBRARY_FLAGS)
